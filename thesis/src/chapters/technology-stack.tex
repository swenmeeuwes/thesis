...
\noindent Er bevindt zich een miniem aantal componenten op een enkele pagina. Dit duidt op de behoefte aan een kleine user interface library zonder navigatie functionaliteit.
...
\label{subsec:uiframeworksandlibraries}
...
\label{subsubsec:resultsuiframeworks}
...
\label{subsec:diagramminglibraries}
...
\pagebreak
\subsection{Eisen}
\label{subsec:diagramminglibraryrequirements}
