\begin{appendices}
    ...
    \includepdf[pages=-,scale=.8,pagecommand=\chapter{Getuigenverklaringen}]{assets/pdf/Getuigenverklaring_bedrijfsbegeleider.pdf}
    \includepdf[pages=-,scale=.8,pagecommand={}]{assets/pdf/Getuigenverklaring_opdrachtgever.pdf}
\end{appendices}