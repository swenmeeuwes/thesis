...
\section{Behoeftes}
Door mee te werken aan een narrative game project kwamen er enkele behoeftes naar boven. Daarnaast kwamen er in de wekelijkse meetings verdere behoeftes naar boven. Uit deze behoeftes zijn use cases opgesteld (zie bijlage \autoref{app:usecasesprojectstructuur}).
%kort de behoeftes vermelden
