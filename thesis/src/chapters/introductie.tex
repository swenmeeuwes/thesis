...
\begin{wrapfigure}{r}{0.4\textwidth}
    \includegraphics[width=0.38\textwidth]{VisualScriptingInEditor}
...
\section{Een ontwikkelomgeving voor interactieve narratieven}
De ‘Corporate Learning’ afdeling van \&ranj maakt vaak gebruik van narrative game om oplossingen te realiseren. Om efficiënt te werken en overtollig werk te voorkomen is het ontwikkelproces van deze game gestandaardiseerd. Er is een ontwikkelomgeving opgezet waarin dit type games ontwikkeld kunnen worden. Naast de story- en dialog editor maakt het ‘narrative game template’ (NGT) een groot deel uit van deze ontwikkelomgeving. Het NGT is een leeg raamwerk met een achterliggende engine om exports van de editors te verwerken. Deze exportbestanden interpreteert en reflecteert het NGT als een speelbare game. Een overzicht van de relaties tussen de editors en het NGT is terug te zien in \autoref{fig:ontwikkelomgevingnarrative}. 

\begin{figure}[htb]
    \includegraphics[width=\textwidth]{OntwikkelOmgevingNarrative}
