...
\subsection{User interface editors}
...
\textit{* zou eventueel zelf met relatief weinig moeite geïmplementeerd kunnen worden}
...
% todo: make a proper table out of the image
\begin{figure}[htb]
