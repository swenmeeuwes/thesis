...
In een digitale interactive narratief wordt er gebruik gemaakt van variabelen om conditionaliteit mogelijk te maken. Het beschikken over gedeelde variabelen tussen verhaal en dialoog is nodig om het verhaal te kunnen sturen volgens gemaakte keuzes in het dialoog en wederzijds. Deze gedeelde variabelen worden gezien als een overkoepelend construct en wekt de vraag naar een overkoepelende projectstructuur op waarbij variabelen, verhalen en dialogen samen komen en met elkaar verbonden worden.
...
% Tijdens het gebruik van de editor is het wenselijk om assets te kunnen categoriseren
% referentie is zwak -> verkeerd type of niet bestaand
% inhaken op afbeelding ...


%In een overkoepelende projectstructuur kunnen ....

\section{Stappen richting een overkoepelende projectstructuur}
% wat moet er gedaan worden om problemen op te lossen en om aan behoefte te voldoen.
