...
%Steps towards a more flexible for telling various digital interactive stories are made by (1) making clever use of JSON-schema for defining content types, (2) 
